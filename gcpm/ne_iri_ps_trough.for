...
d     print *,'entering ne_iri_ps_trough with',r,al,alatr
d     print *,'           and ',amlt,akp,itime
c
...
d	print *,'back from ne_iri_ps_trough_eq=',eq_iri_ps_trough
d     print *,'bridge? ',amlt,amlt_o,akp,akp_o,al,al_o
d     print *,'      ? ',itime(1),itime1_o,itime(2),itime2_o
...
d     print *,'Evaluate field aligned power law function'
d     print *,'showit:',(amlt-amlt_o),(akp-akp_o),(al-al_o)
d     print *,(itime(1)-itime1_o),(itime(2)-itime2_o)
c
...
d     print *,'back from iri_ps_bridge with stat<0'
d     print *,'     ',r,alatr,along,ne_iri_ps_trough
	    return
	  endif
	  al_o=al
	  amlt_o=amlt
	  ...
	  itime1_o=itime(1)
	  itime2_o=itime(2)
d	print *,'ne_iri_ps_trough transh=',transh,alpha,dno,co,
d    &                  switchh,switchw,istat
d      print *,'   >',r,al,alatr,amlt,itime,eq_iri_ps_trough
	end if
...
d      print *,'bridge ne=',eq_bridge,dno,aheight,alpha,co
...
d	print *,'swtch',outf(1,1),eq_bridge,swtch1,ne_iri_ps_trough
          endif
	  else

	    ne_iri_ps_trough=eq_bridge
	  end if
d     print *,'leaving ne_iri_ps_trough=',ne_iri_ps_trough
d     print *,'                        =',r,al,alatr,amlt,akp
c
d      print *,'ne_iri_ps_trough:',eq_bridge,ne_iri_ps_trough
	return
	end
