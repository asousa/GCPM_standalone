...
c
d     print *,'into cap:',r,alatr,amlt,aheight,along
...
d     print *,'cap setup:',nb1,refn,powern,ne_iri_cap
c
...
d     print *,'cap height trans:',edensity_iri,ne_iri_cap,switch2,switch3
	  end if
	end if
c
d     print *,'leaving cap:',ne_iri_cap
	return
	end